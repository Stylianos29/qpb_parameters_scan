...
# KL-specific
MODIFIABLE_PARAMETERS_CHECK_FUNCTION_DICTIONARY["KL_DIAGONAL_ORDER"]="is_positive_integer"
...
# KL-specific
MODIFIABLE_PARAMETERS_RANGE_OF_VALUES_GENERATOR_DICTIONARY["KL_DIAGONAL_ORDER"]="general_range_of_values_generator"
