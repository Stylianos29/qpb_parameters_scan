...
test_NEUBERGER_ITERABLE_PARAMETERS_NAMES_ARRAY() {

    local tested_array="NEUBERGER_ITERABLE_PARAMETERS_NAMES_ARRAY"
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS"\
            "APE_ITERATIONS" "APE_ALPHA" "CLOVER_TERM_COEFFICIENT" "BARE_MASS" \
            "RHO_VALUE" "KL_DIAGONAL_ORDER" "SOLVER_INNER_EPSILON" \
            "SOLVER_INNER_MAX_ITERATIONS" "SCALING_FACTOR")
...
test_NEUBERGER_INVERT_ITERABLE_PARAMETERS_NAMES_ARRAY() {

    local tested_array="NEUBERGER_INVERT_ITERABLE_PARAMETERS_NAMES_ARRAY"
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS"\
            "APE_ITERATIONS" "APE_ALPHA" "CLOVER_TERM_COEFFICIENT" "BARE_MASS" \
            "RHO_VALUE" "KL_DIAGONAL_ORDER" "SOLVER_INNER_EPSILON" \
            "SOLVER_INNER_MAX_ITERATIONS" "SCALING_FACTOR" "SOLVER_EPSILON" \
...
test_ZOLOTAREV_ITERABLE_PARAMETERS_NAMES_ARRAY() {

    local tested_array="ZOLOTAREV_ITERABLE_PARAMETERS_NAMES_ARRAY"
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS"\
            "APE_ITERATIONS" "APE_ALPHA" "CLOVER_TERM_COEFFICIENT" "BARE_MASS" \
            "RHO_VALUE" "ZOLOTAREV_ORDER" "SOLVER_INNER_EPSILON" \
            "SOLVER_INNER_MAX_ITERATIONS" "SCALING_FACTOR" "LANCZOS_EPSILON" \
            "LANCZOS_MAX_ITERATIONS" "DELTA_MIN" "DELTA_MAX")
...
test_ZOLOTAREV_INVERT_ITERABLE_PARAMETERS_NAMES_ARRAY() {

    local tested_array="ZOLOTAREV_INVERT_ITERABLE_PARAMETERS_NAMES_ARRAY"
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS"\
            "APE_ITERATIONS" "APE_ALPHA" "CLOVER_TERM_COEFFICIENT" "BARE_MASS" \
            "RHO_VALUE" "ZOLOTAREV_ORDER" "SOLVER_INNER_EPSILON" \
            "SOLVER_INNER_MAX_ITERATIONS" "SCALING_FACTOR" "LANCZOS_EPSILON" \
