...
test_BARE_ITERABLE_PARAMETERS_NAMES_ARRAY() {
    ...
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS" "APE_ITERATIONS" "APE_ALPHA" "CLOVER_TERM_COEFFICIENT" "BARE_MASS" "KAPPA_VALUE")
...
test_BARE_INVERT_ITERABLE_PARAMETERS_NAMES_ARRAY() {
    ...
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS" "APE_ITERATIONS" "APE_ALPHA" "CLOVER_TERM_COEFFICIENT" "BARE_MASS" "KAPPA_VALUE" "SOLVER_EPSILON" "SOLVER_MAX_ITERATIONS")
...
test_CHEBYSHEV_ITERABLE_PARAMETERS_NAMES_ARRAY() {
    ...
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS" "APE_ITERATIONS" "APE_ALPHA" "CLOVER_TERM_COEFFICIENT" "BARE_MASS" "RHO_VALUE" "NUMBER_OF_CHEBYSHEV_TERMS" "LANCZOS_EPSILON" "LANCZOS_MAX_ITERATIONS" "DELTA_MIN" "DELTA_MAX")
...
test_CHEBYSHEV_INVERT_ITERABLE_PARAMETERS_NAMES_ARRAY() {
    ...
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS" "APE_ITERATIONS" "APE_ALPHA" "CLOVER_TERM_COEFFICIENT" "BARE_MASS" "RHO_VALUE" "NUMBER_OF_CHEBYSHEV_TERMS" "LANCZOS_EPSILON" "LANCZOS_MAX_ITERATIONS" "DELTA_MIN" "DELTA_MAX" "SOLVER_EPSILON" "SOLVER_MAX_ITERATIONS")
...
test_KL_ITERABLE_PARAMETERS_NAMES_ARRAY() {
    ...
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS" "APE_ITERATIONS" "APE_ALPHA" "CLOVER_TERM_COEFFICIENT" "BARE_MASS" "RHO_VALUE" "KL_DIAGONAL_ORDER" "SOLVER_INNER_EPSILON" "SOLVER_INNER_MAX_ITERATIONS" "SCALING_FACTOR")
...
test_KL_INVERT_ITERABLE_PARAMETERS_NAMES_ARRAY() {
    ...
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS" "APE_ITERATIONS" "APE_ALPHA" "CLOVER_TERM_COEFFICIENT" "BARE_MASS" "RHO_VALUE" "KL_DIAGONAL_ORDER" "SOLVER_INNER_EPSILON" "SOLVER_INNER_MAX_ITERATIONS" "SCALING_FACTOR" "SOLVER_EPSILON" "SOLVER_MAX_ITERATIONS")
